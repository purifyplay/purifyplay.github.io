...
async function onHide() {
  ...
  try {
    ...
    error("The hidden URL appears corrupted. It must be a password-protected Link Lock URL. <a href=\"https://gitmaster-user.github.io/redirection/site\">Click here to add a password.</a>");
    return;
...
function main() {
  if (window.location.hash) {
    document.querySelector("#encrypted-url").value =
      `https://gitmaster-user.github.io/prelock/${window.location.hash}`;
