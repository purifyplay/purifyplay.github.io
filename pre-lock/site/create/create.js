...
async function onEncrypt() {
  ...
  const encrypted = await generateFragment(url, password, hint, useRandomSalt,
      useRandomIv);
  const output = `https://gitmaster-user.github.io/pre-lock/site/#${encrypted}`;

  document.querySelector("#output").value = output;
  highlight("output");

  // Adjust "Hidden Bookmark" link
  document.querySelector("#bookmark").href = `https://gitmaster-user.github.io/pre-lock/hidden/#${encrypted}`;
